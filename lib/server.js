...
function Server(options) {
    ...
    assert.optionalFunc(options.cbStartEncode, 'cbStartEncode');
    this._cbStartEncode = options.cbStartEncode || null;
    assert.optionalFunc(options.cbStopEncode, 'cbStopEncode');
    this._cbStopEncode = options.cbStopEncode || null;
...
Server.prototype.onConnection = function onConnection(conn) {
    ...
    messageEncoder._cbStart = this._cbStartEncode;
    messageEncoder._cbStop = this._cbStopEncode;
